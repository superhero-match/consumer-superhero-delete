...
type Health struct {
	...
	Port             string `env:"HEALTH_SERVER_PORT" default:":8060"`
	ShutdownEndpoint string `env:"HEALTH_SERVER_SHUTDOWN_ENDPOINT" default:"/api/v1/consumer_superhero_delete_health/shutdown"`
